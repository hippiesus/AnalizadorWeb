                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="nombre"><g:message code="perfil.nombre.label" default="Nombre" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: perfilInstance, field: 'nombre', 'errors')}">
                                    <g:textField name="nombre" value="${perfilInstance?.nombre}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="descripcion"><g:message code="perfil.descripcion.label" default="Descripcion" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: perfilInstance, field: 'descripcion', 'errors')}">
                                    <g:textField name="descripcion" value="${perfilInstance?.descripcion}" />
                                </td>
                            </tr>
