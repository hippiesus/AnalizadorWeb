            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="defecto.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: defectoInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="defecto.programas.label" default="Programas" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${defectoInstance.programas}" var="p">
