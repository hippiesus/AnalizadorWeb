            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="proyecto.descripcion.label" default="Descripcion" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: proyectoInstance, field: "descripcion")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="proyecto.programas.label" default="Programas" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="proyecto.usuarioProyecto.label" default="Usuario Proyecto" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${proyectoInstance.usuarioProyecto}" var="u">
